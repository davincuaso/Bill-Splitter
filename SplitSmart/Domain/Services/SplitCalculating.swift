...
public protocol SplitCalculating {
    func calculateSplit(group: BillGroup, items: [BillItem], charges: Charges) -> SplitResult
}
...
public struct DefaultSplitCalculator: SplitCalculating {
    ...
    public func calculateSplit(group: BillGroup, items: [BillItem], charges: Charges) -> SplitResult {
